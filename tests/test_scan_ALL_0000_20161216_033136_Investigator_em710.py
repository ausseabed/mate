...
TEST_FILE = "0000_20161216_033136_Investigator_em710.all"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(Y['byteCount'], 3568070)

    def test_get_size_n_pings(self):
        self.test.get_size_n_pings(1)

    def test_pings(self):
        self.assertEqual(self.test.get_total_pings('N'), 552)
        ...
        self.assertEqual(self.test.get_total_pings(), 1656)
        self.assertEqual(self.test.get_missed_pings(), 0)
