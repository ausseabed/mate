...
TEST_FILE = "0063_20201115_020404_Investigator_em710_EM710.gsf"
...
class TestMateScanGsf(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        five = self.test.get_datagram_info(5)
        self.assertEqual(five, None)
        swath_bathymetry = self.test.get_datagram_info(2)
        self.assertEqual(swath_bathymetry['byteCount'], 23528108)
    ...
    def test_pings(self):
        self.assertEqual(self.test.get_total_pings(2), 1199)
        self.assertEqual(self.test.get_missed_pings(2), 0)
        self.assertEqual(self.test.get_total_pings('-'), 0)
        self.assertEqual(self.test.get_missed_pings('-'), 0)
        self.assertEqual(self.test.get_total_pings(), 1199)
        self.assertEqual(self.test.get_missed_pings(), 0)
