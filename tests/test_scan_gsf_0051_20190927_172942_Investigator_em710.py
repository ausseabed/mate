...
TEST_FILE = "0051_20190927_172942_Investigator_em710.gsf"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(swath_bathymetry['byteCount'], 15487560)
    ...
    def test_pings(self):
        self.assertEqual(self.test.get_total_pings(2), 2016)
        ...
        self.assertEqual(self.test.get_total_pings(), 2016)
        self.assertEqual(self.test.get_missed_pings(), 0)
