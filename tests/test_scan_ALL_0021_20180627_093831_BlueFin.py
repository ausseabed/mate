...
TEST_FILE = "0021_20180627_093831_BlueFin.all"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(Y['byteCount'], 21046796)

    def test_get_size_n_pings(self):
        self.test.get_size_n_pings(1)

    def test_pings(self):
        self.assertEqual(self.test.get_total_pings('N'), 2709)
        ...
        self.assertEqual(self.test.get_total_pings(), 8127)
        self.assertEqual(self.test.get_missed_pings(), 0)
