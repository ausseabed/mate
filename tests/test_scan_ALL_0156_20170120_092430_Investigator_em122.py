...
TEST_FILE = "0156_20170120_092430_Investigator_em122.all"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(Y['byteCount'], 6403360)

    def test_get_size_n_pings(self):
        self.test.get_size_n_pings(1)

    def test_pings(self):
        self.assertEqual(self.test.get_total_pings('N'), 171)
        ...
        self.assertEqual(self.test.get_total_pings(), 513)
        self.assertEqual(self.test.get_missed_pings(), 0)
