...
TEST_FILE = "0231_20201015_063548_Investigator_em122.gsf"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(swath_bathymetry['byteCount'], 15130752)
    ...
    def test_pings(self):
        self.assertEqual(self.test.get_total_pings(2), 1756)
        ...
        self.assertEqual(self.test.get_total_pings(), 1756)
        self.assertEqual(self.test.get_missed_pings(), 0)
