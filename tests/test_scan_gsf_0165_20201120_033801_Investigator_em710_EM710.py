...
TEST_FILE = "0194_20201013_213114_Investigator_em122.gsf"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(swath_bathymetry['byteCount'], 16089464)
    ...
    def test_pings(self):
        self.assertEqual(self.test.get_total_pings(2), 1857)
        ...
        self.assertEqual(self.test.get_total_pings(), 1857)
        self.assertEqual(self.test.get_missed_pings(), 0)
