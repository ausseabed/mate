...
TEST_FILE = "0010_20201115_110336_Investigator_em122_EM122.gsf"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(swath_bathymetry['byteCount'], 5365728)
    ...
    def test_pings(self):
        self.assertEqual(self.test.get_total_pings(2), 81)
        ...
        self.assertEqual(self.test.get_total_pings(), 81)
        self.assertEqual(self.test.get_missed_pings(), 0)
