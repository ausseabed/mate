...
TEST_FILE = "0140_20201121_044253_Investigator_em122_EM122.gsf"
...
class TestMateScanGsf(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(swath_bathymetry['byteCount'], 28501692)
    ...
    def test_pings(self):
        self.assertEqual(self.test.get_total_pings(2), 473)
        ...
        self.assertEqual(self.test.get_total_pings(), 473)
        self.assertEqual(self.test.get_missed_pings(), 0)
