...
TEST_FILE = "0155_20170120_085932_Investigator_em122.all"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(Y['byteCount'], 2471714)

    def test_get_size_n_pings(self):
        self.test.get_size_n_pings(1)

    def test_pings(self):
        self.assertEqual(self.test.get_total_pings('N'), 74)
        ...
        self.assertEqual(self.test.get_total_pings(), 222)
        self.assertEqual(self.test.get_missed_pings(), 0)
