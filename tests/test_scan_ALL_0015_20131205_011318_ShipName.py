...
TEST_FILE = "0015_20131205_011318_ShipName.all"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(D['recordCount'], 4232)
    ...
    def test_pings(self):
        self.assertEqual(self.test.get_total_pings('N'), 0)
        ...
        self.assertEqual(self.test.get_total_pings(), 12691)
        self.assertEqual(self.test.get_missed_pings(), 290)
    ...
    def test_ellipsoid_height_availability(self):
        self.assertFalse(self.test.ellipsoid_height_availability())
