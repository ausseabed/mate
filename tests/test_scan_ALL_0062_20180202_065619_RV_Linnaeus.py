...
TEST_FILE = "0062_20180202_065619_RV_Linnaeus.all"
...
class TestMateScanALL(unittest.TestCase):
    ...
    def test_get_datagram_info(self):
        ...
        self.assertEqual(Y['byteCount'], 23211884)

    def test_get_size_n_pings(self):
        self.test.get_size_n_pings(1)

    def test_pings(self):
        self.assertEqual(self.test.get_total_pings('N'), 4513)
        ...
        self.assertEqual(self.test.get_total_pings(), 13539)
        self.assertEqual(self.test.get_missed_pings(), 0)
